...
const Payment_details = ({navigation})=>{
    ...
    return (
        ...
        <View style={{borderRadius:20,backgroundColor:'#ffffff', borderWidth: 1, width:340,height:30,marginLeft:10,marginTop:20,flexDirection:'row'}}>
            ...
            <TouchableOpacity style={{borderRadius:20,backgroundColor:'#fdc92e',width:70,height:28,marginLeft:20,marginTop:20}} onPress={()=>navigation.navigate('order')}>
                <Text style={{fontWeight:'bold',textAlign:'center'}}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{borderRadius:20,backgroundColor:'#fdc92e',width:70,height:28,marginLeft:100,marginTop:20}}onPress={()=>navigation.navigate('pay')}>
                <Text style={{fontWeight:'bold',textAlign:'center'}}>Conform</Text>
            </TouchableOpacity>
            </View>
